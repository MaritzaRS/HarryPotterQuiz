...
public class Quiz extends JPanel{
  ...
  //JFrame frame;
	...
	public Quiz() {
		...
		System.out.println("Hufflepuff: " + (double)(hScore * 1.0)/(20)*100 + "%");
		System.out.println("Gryffindor: " + (double)(gScore*1.0)/(20)*100 + "%");
		System.out.println("Ravenclaw: " + (double)(rScore*1.0)/(20)*100 + "%");
		System.out.println("Slytherin: " + (double)(sScore*1.0)/(20)*100 + "%");
